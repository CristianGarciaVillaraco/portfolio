      ...
      >
        ...
        >
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.97 }}
            className="flex items-center gap-2 px-6 py-3 border border-slate-500 hover:border-sky-400 text-slate-300 hover:text-sky-400 rounded-lg font-medium transition-colors"
          >
