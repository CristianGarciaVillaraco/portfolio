...
export default function Landing({ data }: LandingProps) {
  ...
  return (
    <section
      id="landing"
      ref={sectionRef}
      className="min-h-screen flex flex-col justify-center items-center text-center px-6 bg-gradient-to-br from-slate-900 to-slate-800 relative overflow-hidden"
    >
      <motion.div
        aria-hidden
      ...
      >
        ...
        <motion.h1 variants={item} className="text-5xl md:text-6xl font-bold text-white mb-4">
          {data.name}
        </motion.h1>
        <motion.h2 variants={item} className="text-xl md:text-2xl text-sky-400 font-semibold mb-3">
          {data.title}
        </motion.h2>
        <motion.p
          variants={item}
        ...
        <motion.div variants={item} className="flex gap-3 justify-center items-center">
          <motion.a
      ...
      <motion.a
        ...
        className="mt-8 sm:mt-0 sm:absolute sm:bottom-16 sm:left-1/2 sm:-translate-x-1/2 text-slate-500 hover:text-sky-400 transition-colors"
      >
        <svg
          width="24"
          height="24"
